 ...
 */
 ...
 let TG_BOT_TOKEN =
   $.getdata("TG_BOT_TOKEN") || `1611403890:AAH9Gq0pMYdxAx4csnURFuNADVCwJ2moEYc`;
 ...
 function getGiftList() {
   const url = `https://wq.jd.com/fav_snsgift/QueryShopActive?venderId=${venderId}&sceneval=2&g_login_type=1&callback=jsonpCBKC&g_ty=ls`;
   let opt = {
     url: url,
